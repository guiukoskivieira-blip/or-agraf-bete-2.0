...
export function getInitialProductsTemplate(tenantId: string): Product[] {
  ...
  return [
    ...
    // 6. Banner em lona (METRO QUADRADO - m²)
    {
      ...
      availableFinishings: ['Ilhós', 'Bastão e cordão', 'Bainha', 'Solda de lona', 'Instalação'],
      linkedFinishings: [
        { finishingName: 'Ilhós', isRequired: false, isDefaultSelected: false, displayOrder: 1, isActive: true },
        { finishingName: 'Bastão e cordão', isRequired: false, isDefaultSelected: false, displayOrder: 2, isActive: true },
        { finishingName: 'Bainha', isRequired: false, isDefaultSelected: false, displayOrder: 3, isActive: true },
        { finishingName: 'Solda de lona', isRequired: false, isDefaultSelected: false, displayOrder: 4, isActive: true },
    ...
    // 7. Faixa em lona (METRO LINEAR)
    {
      ...
      defaultMaterial: 'Lona frontlight 440 g',
      availableMaterials: ['Lona frontlight 440 g', 'Lona blackout'],
      defaultFinishing: 'Bainha',
      availableFinishings: ['Ilhós', 'Bainha', 'Solda de lona'],
      linkedFinishings: [
        { finishingName: 'Ilhós', isRequired: false, isDefaultSelected: false, displayOrder: 1, isActive: true },
        { finishingName: 'Bainha', isRequired: false, isDefaultSelected: false, displayOrder: 2, isActive: true },
        { finishingName: 'Solda de lona', isRequired: false, isDefaultSelected: false, displayOrder: 3, isActive: true },
      ],
      productionDays: 2,
    ...
    // 12. Wind banner (UNIDADE)
    {
      ...
      defaultFinishing: 'Costura',
      availableFinishings: ['Costura'],
      linkedFinishings: [
        { finishingName: 'Costura', isRequired: true, isDefaultSelected: true, displayOrder: 1, isActive: true },
      ],
      productionDays: 4,
    ...
    // 14. Plotagem de veículo (METRO QUADRADO - m²)
    {
      ...
      availableFinishings: ['Aplicação'],
      linkedFinishings: [
        { finishingName: 'Aplicação', isRequired: false, isDefaultSelected: false, displayOrder: 1, isActive: true },
      ],
      productionDays: 3,
